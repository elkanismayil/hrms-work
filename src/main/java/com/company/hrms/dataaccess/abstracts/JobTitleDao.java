...
public interface JobTitleDao extends JpaRepository<JobTitle, Integer> {
    ...
    @Modifying
    @Query(value = "UPDATE JobTitle j SET j.jobDescription=:jobDescription WHERE EXISTS j.id = :id", nativeQuery = true)
    JobTitle updateFieldById(String jobDescription, int id);
}
